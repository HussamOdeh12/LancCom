      ...
      <main id="main-content" className="flex-1 text-start">
        ...
        <section className="py-16 bg-slate-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 space-y-2 relative overflow-hidden">
                <div className="flex items-center justify-between text-xs text-slate-400">
                  <span className="font-semibold uppercase tracking-wider">{strings.credentials.licenceNo}</span>
                  <FileText className="w-4 h-4 text-cyan-400 shrink-0" />
                </div>
                <div className="text-lg sm:text-xl font-bold font-mono text-cyan-300" dir="ltr">
              ...
              <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 space-y-2">
                ...
                <div className="text-base sm:text-lg font-bold font-mono text-white" dir="ltr">
              ...
              <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-6 space-y-2">
                ...
                <div className="text-base sm:text-lg font-bold text-white font-mono" dir="ltr">
        ...
        <section className="py-16 bg-slate-900 border-t border-b border-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {LICENSED_ACTIVITIES.map((act) => (
                <div
                  ...
                  className="bg-slate-950 border border-slate-800 hover:border-cyan-500/40 rounded-3xl p-6 space-y-4 flex flex-col justify-between transition-all"
                >
            ...
            <div className="p-6 rounded-2xl bg-slate-950/60 border border-slate-800 flex items-start space-x-4 rtl:space-x-reverse">
              <div className="p-2.5 rounded-xl bg-cyan-950 border border-cyan-500/30 text-cyan-400 shrink-0 mt-0.5">
              ...
              <div className="space-y-1.5 text-xs sm:text-sm text-slate-300 leading-relaxed">
                ...
                <div className="pt-2">
                  <Link
                    href="/services"
                    className="inline-flex items-center space-x-1.5 rtl:space-x-reverse text-cyan-400 hover:text-cyan-300 font-bold text-xs group"
                  >
        ...
        <section className="py-16 bg-slate-900 border-t border-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-slate-950 border border-slate-800 rounded-3xl p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8 text-start shadow-2xl">

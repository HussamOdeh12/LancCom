          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-8 rounded-3xl bg-slate-950 border border-slate-800 space-y-6 flex flex-col justify-between">
                <div className="space-y-4">
                  <div className="w-12 h-12 rounded-2xl bg-cyan-950 border border-cyan-500/30 flex items-center justify-center text-cyan-400">
                ...
                <div>
                  <Link
                    href="/credentials"
                    className="inline-flex items-center space-x-2 rtl:space-x-reverse text-xs sm:text-sm font-bold text-cyan-400 hover:text-cyan-300 group"
                  >

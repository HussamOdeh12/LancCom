...
export function Hero() {
  ...
  return (
    <section className="relative bg-slate-950 text-white pt-10 pb-16 lg:pt-16 lg:pb-24 overflow-hidden border-b border-slate-900 text-start">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-start">
            ...
            {/* Key Value Pillars */}
            <div className="pt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 border-t border-slate-800/80 text-start">
              <div className="p-3 bg-slate-900/40 rounded-xl border border-slate-800/60 flex items-start space-x-2.5 rtl:space-x-reverse">
          ...
          <div className="lg:col-span-5 text-start">
            <div className="relative bg-slate-900/95 border border-slate-700/80 rounded-2xl shadow-2xl p-6 backdrop-blur-xl overflow-hidden space-y-5">
              {/* Card Header */}
              ...
              <div className="space-y-2.5">
                <div className="p-3 bg-slate-950 rounded-xl border border-slate-800 text-xs flex items-center justify-between">
                  ...
                  <span className="text-white font-bold font-mono">09 May 2007</span>
                </div>
                ...
                <div className="p-3 bg-slate-950 rounded-xl border border-slate-800 text-xs flex items-center justify-between">
                  ...
                  <span className="text-cyan-400 font-medium">{COMPANY_INFO.ownership}</span>
                </div>
                ...
                <div className="p-3 bg-slate-950 rounded-xl border border-slate-800 text-xs flex items-center justify-between">
                  ...
                  <span className="text-teal-400 font-medium">{COMPANY_INFO.deployedStaff}</span>
                </div>
                ...
                <div className="p-3 bg-slate-950 rounded-xl border border-slate-800 text-xs flex items-center justify-between">
                  ...
                  <span className="text-amber-400 font-medium">6 Economic Activities</span>
                </div>
              </div>

              {/* Location Strip */}
              <div className="p-3.5 bg-cyan-950/40 border border-cyan-500/20 rounded-xl text-xs space-y-1">
              ...
              <div className="pt-2">
                <Link
                  href="/contact"
                  className="w-full py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs rounded-xl border border-slate-700 transition-colors flex items-center justify-center space-x-2 rtl:space-x-reverse"
                >

...
export function SelectedExperience() {
  ...
  return (
    <section id="experience" className="py-20 bg-slate-950 text-white relative text-start border-b border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {DOCUMENTED_EXPERIENCE.map((item, idx) => (
            <div
              key={item.id}
              className="bg-slate-900/80 border border-slate-800 hover:border-slate-700 rounded-2xl p-6 transition-all duration-300 flex flex-col justify-between text-start group"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 text-cyan-400 group-hover:border-cyan-500/30 transition-all">
                ...
                <div className="p-3 bg-slate-950 rounded-xl border border-slate-800/80 text-xs space-y-1 mt-3">
        ...
        <div className="text-center pt-2">
          <Link
            href="/experience"
            className="inline-flex items-center space-x-2 rtl:space-x-reverse px-6 py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs rounded-xl border border-slate-700 transition-colors"
          >

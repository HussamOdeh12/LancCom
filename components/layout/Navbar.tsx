...
export function Navbar() {
  ...
  const serviceIconMap: Record<string, React.ReactNode> = {
    'erp-system': <Database className="w-4 h-4 text-cyan-400 shrink-0" />,
    'mobility-solutions': <Smartphone className="w-4 h-4 text-blue-400 shrink-0" />,
    'it-resources-networking': <Network className="w-4 h-4 text-teal-400 shrink-0" />,
    'security-solutions': <ShieldCheck className="w-4 h-4 text-emerald-400 shrink-0" />,
    'tracking-systems': <Navigation className="w-4 h-4 text-sky-400 shrink-0" />,
    'rfid-solutions': <Radio className="w-4 h-4 text-indigo-400 shrink-0" />,
    'ecommerce-web': <Globe className="w-4 h-4 text-amber-400 shrink-0" />,
    'it-managed-services': <Headset className="w-4 h-4 text-purple-400 shrink-0" />,
  };
                ...
                return (
                  ...
                  >
                    ...
                    {servicesDropdownOpen && (
                      <div className="absolute top-full start-0 w-[620px] bg-slate-900/98 backdrop-blur-xl border border-slate-700/80 rounded-2xl shadow-2xl p-4 mt-1 grid grid-cols-2 gap-2 animate-in fade-in slide-in-from-top-2 duration-150 z-50 text-start">

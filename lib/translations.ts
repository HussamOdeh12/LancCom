...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    contact: {
      ...
      formTitle: 'Prepare Inquiry Email',
      formDesc: 'Completing this form will open your email application with the enquiry details prepared for sending to LandCom.',
      fullName: 'Full Name',
      ...
      successTitle: 'Email Prepared',
      successDesc: 'Your email application will open with the enquiry details formatted for Info@landcom.ae.',
    },
    footer: {
  ...
  ar: {
    ...
    contact: {
      ...
      formTitle: 'تجهيز رسالة الاستفسار',
      formDesc: 'تعبئة هذا النموذج ستفتح تطبيق البريد الإلكتروني الخاص بك مع تجهيز بيانات الاستفسار لإرسالها إلى لاند كوم.',
      ...
      submit: 'تجهيز البريد الإلكتروني',
      submitting: 'جاري تجهيز البريد...',
      successTitle: 'تم تجهيز رسالة البريد',
      successDesc: 'يمكنك الآن إرسال الرسالة مباشرة عبر تطبيق البريد الإلكتروني إلى Info@landcom.ae.',
    },
    footer: {

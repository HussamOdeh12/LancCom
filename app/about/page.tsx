...
import { COMPANY_INFO, LICENSED_ACTIVITIES, WHY_LANDCOM } from '@/lib/data';
...
export default function AboutPage() {
  ...
  const getWhyIcon = (iconName: string) => {
    switch (iconName) {
      case 'MapPin': return <MapPin className="w-5 h-5 text-cyan-400 shrink-0" />;
      case 'Users': return <Users className="w-5 h-5 text-cyan-400 shrink-0" />;
      case 'Zap': return <Zap className="w-5 h-5 text-cyan-400 shrink-0" />;
      case 'Building2': return <Building2 className="w-5 h-5 text-cyan-400 shrink-0" />;
      case 'Sparkles': return <Sparkles className="w-5 h-5 text-cyan-400 shrink-0" />;
      default: return <CheckCircle2 className="w-5 h-5 text-cyan-400 shrink-0" />;
    }
  };
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
              <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800">
                <div className="text-2xl sm:text-3xl font-black text-cyan-400 font-mono">2007</div>
              ...
              <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800">
                <div className="text-2xl sm:text-3xl font-black text-cyan-400 font-mono">19+</div>
                <div className="text-xs font-bold text-white mt-1">
              ...
              <div className="p-5 rounded-2xl bg-slate-900/80 border border-slate-800">
                <div className="text-2xl sm:text-3xl font-black text-cyan-400 font-mono">32+</div>
                <div className="text-xs font-bold text-white mt-1">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-7 space-y-8 text-start">
                ...
                <div className="p-6 sm:p-8 bg-slate-900 border border-slate-800 rounded-3xl relative overflow-hidden">
                ...
                <div className="p-6 sm:p-8 bg-slate-900/60 border border-slate-800 rounded-3xl space-y-4">
                  <div className="flex items-center space-x-3 rtl:space-x-reverse">
                    <div className="p-2.5 rounded-xl bg-blue-950 border border-blue-500/30 text-blue-400 shrink-0">
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 space-y-5 text-start">
                  <h3 className="text-base font-bold text-white flex items-center space-x-2.5 rtl:space-x-reverse">
                  ...
                  <div className="space-y-4">
                    {WHY_LANDCOM.map((pillar) => (
                      <div key={pillar.id} className="flex items-start space-x-3 rtl:space-x-reverse p-3 rounded-xl bg-slate-950/80 border border-slate-800/80">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-4 text-start">
                  ...
                  <div className="pt-2 border-t border-slate-800 space-y-2 text-xs text-slate-400 font-mono">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {LICENSED_ACTIVITIES.map((act) => (
                <div
                  key={act.id}
                  className="p-4 bg-slate-950 rounded-2xl border border-slate-800 flex items-start space-x-3 rtl:space-x-reverse"
                >
                  <span className="w-6 h-6 rounded-full bg-slate-900 text-cyan-400 border border-cyan-500/30 text-xs font-mono font-bold flex items-center justify-center shrink-0 mt-0.5">
                    0{act.id}
                  </span>
